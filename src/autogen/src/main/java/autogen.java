...
class autogen implements jas.RuntimeConstants
{
  ...
  public static void main(String argv[])
    throws IOException
  {
    File outputDirectory = new File(argv[0]);
    outputDirectory.mkdirs();

    PrintStream initer =
	new PrintStream(new FileOutputStream(new File(outputDirectory, "AutoInit.java")));
    initer.println("package scm;\n\nimport jas.*;");
    initer.println("class AutoInit\n{\n  static void fillit(Env e)\n  {");

                                // Generate types in the system.
    PrintStream doit = new PrintStream(new FileOutputStream(new File(outputDirectory, "AutoTypes.java")));
    ...
    doit = new PrintStream(new FileOutputStream(new File(outputDirectory, "AutoProcs.java")));
    doit.println("package scm;\n\nimport jas.*;");
